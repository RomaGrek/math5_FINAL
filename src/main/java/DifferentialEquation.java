...
public class DifferentialEquation {
    ...
    /*!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!  МОЖЕТ БЫТЬ НЕПРАВИЛЬНО РЕШЕН ДИФУР?????!1111*/
    static void advancedEulerMethod1() { // 1 -3 1 3
        ...
        /* вот тут чертиться просто сам график
        * имеенно тут мы используем С для подстановки его в обшее решение дифура,
        * которое мы посчитали грубо говоря на бумаге (оно у нас в классе Function)
        * больше нигде мы не используем С, потому что оно нужно для традиционного метода решения на бумаге
        * а мы в лабе делаем методом эйлера, потому что метод на бумаге мы не можем решаить на компе */
...
//        }
        ...
        /*  пока что хрен знает что это такое, а еще больше не понятно почему этого нету в втором методе решения эйлера */
